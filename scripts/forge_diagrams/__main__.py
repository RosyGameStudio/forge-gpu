...
DIAGRAMS = {
    ...
    "gpu/30": [
        ("reflection_camera.png", diagram_reflection_camera),
        ("oblique_clip_planes.png", diagram_oblique_clip_planes),
        ("frustum_plane_extraction.png", diagram_frustum_plane_extraction),
        ("fresnel_curve.png", diagram_fresnel_curve),
    ...
    "gpu/31": [
        ("keyframe_interpolation.png", diagram_keyframe_interpolation),
        ("quaternion_slerp.png", diagram_quaternion_slerp),
        ("animation_clip_structure.png", diagram_animation_clip_structure),
        ("transform_hierarchy.png", diagram_transform_hierarchy),
        ("path_following.png", diagram_path_following),
        ("animation_timeline.png", diagram_animation_timeline),
    ...
    "gpu/33": [
        ...
        ("storage_buffer_layout.png", diagram_storage_buffer_layout),
        ("pipeline_state_comparison.png", diagram_pipeline_state_comparison),
        ("vertex_pulling_use_cases.png", diagram_vertex_pulling_use_cases),
        ("binding_comparison.png", diagram_binding_comparison),
    ],
    "gpu/34": [
        ("stencil_buffer_concept.png", diagram_stencil_buffer_concept),
        ("stencil_test_pipeline.png", diagram_stencil_test_pipeline),
        ("portal_technique.png", diagram_portal_technique),
    ...
    "gpu/35": [
        ("decal_box_projection.png", diagram_decal_box_projection),
        ("depth_reconstruction.png", diagram_decal_depth_reconstruction),
        ("decal_local_space.png", diagram_decal_local_space),
        ("render_pass_architecture.png", diagram_decal_render_pipeline),
