/*
 * tonemap.vert.hlsl — Fullscreen quad via SV_VertexID
 *
 ...
 * post-processing passes like tone mapping, bloom, and blur.
 *
 ...
 *   2--3
 *
 * UV coordinates are generated to sample the HDR render target.
...
struct VSOutput
{
    ...
    float2 uv       : TEXCOORD0;    /* UV for HDR texture sampling    */
};
