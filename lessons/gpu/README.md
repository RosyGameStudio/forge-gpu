...
*More lessons coming soon:* Textures, depth buffers, 3D transforms, lighting, and more.
...
- **Textures** *(coming)* — Essential for realistic rendering
...
- **Textures & Samplers** — Adding images to your rendering
- **3D Transforms** — MVP matrices and perspective projection
- **Lighting** — Making 3D scenes look realistic
