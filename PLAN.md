...
- [x] **Lesson 13 — Instanced Rendering** — Per-instance vertex buffers, per-instance model matrices as vertex attributes, multi-model scenes (BoxTextured + Duck), efficient draw calls (3 calls for ~44 objects)
